...
- [ ] 10. User scenario tests complete *(ограничено: 9 Playwright smoke-тестов покрывают layout/validation/columns, но полные end-to-end сценарии создания → сохранения → редактирования → удаления черновика не автоматизированы)*
